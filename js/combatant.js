	...
	display(){
		...
		switch(this.type){
			...
			case 99:
				...
				this.layer.stroke(202,51,60,this.fade*(1-this.anim[8]))
				...
				this.layer.endShape()
				this.layer.fill(114,40,119,this.fade*(1-this.anim[9]))
				for(g=0;g<5;g++){
				...
				this.layer.endShape()
				this.layer.noStroke()
				this.layer.fill(242,235,244,this.fade*(1-this.anim[9]))
				for(g=0;g<10;g++){
			...
			case 123:
				...
				this.layer.endShape()
				this.layer.noStroke()
				this.layer.fill(242,235,244,this.fade*(1-this.anim[8]))
				for(g=0;g<10;g++){
					this.layer.triangle(9-g*1.8,-39,7.2-g*1.8,-39,8.1-g*1.8,-36)
				}
				this.layer.strokeJoin(ROUND)
				...
				this.layer.stroke(202,51,60,this.fade*(1-this.anim[8]))
				this.layer.fill(209,80,84,this.fade*(1-this.anim[8]))
				this.layer.quad(6.25,-53,5.75,-55,-5.75,-55,-6.25,-53)
				this.layer.quad(-7.8,-46,7.8,-46,8.2,-44,-8.2,-44)
				this.layer.quad(-8.2,-44,8.2,-44,8.4,-42,-8.4,-42)
				this.layer.triangle(0,-44,-10,-50,-10,-38)
				this.layer.triangle(0,-44,10,-50,10,-38)
				this.layer.rect(0,-44,5,5)
				this.layer.line(1,-46.5,-1,-41.5)
				this.layer.noStroke()
				for(g=1;g<6;g++){
					this.layer.fill(206+g*38/3,107+g*59/3,113+g*61/3,this.fade)
					this.layer.quad(-13.5+(g%2)*2,-72+g*3,-12+(g%2)*2,-66+g*3,-10.5+(g%2)*2,-72+g*3,-12+(g%2)*2,-78+g*3)
