function setupGraphics(){
	...
	graphics.minor[1].strokeWeight(6)
	graphics.minor[1].line(8,12.5,20,34.25)
	graphics.minor[1].line(32,12.5,20,34.25)
	graphics.minor[1].stroke(233,216,194)
	graphics.minor[1].strokeWeight(2)
	graphics.minor[1].point(20,33)
	graphics.minor[1].point(16,26)
	graphics.minor[1].point(24,26)
	graphics.minor[1].point(12,19)
	graphics.minor[1].point(28,19)
	graphics.minor[1].point(8,12)
	graphics.minor[1].point(32,12)
	...
	graphics.minor[3].fill(0)
	graphics.minor[3].ellipse(100,100,180,180)
	graphics.minor[3].fill(255)
	graphics.minor[3].arc(100,100,150,150,-38,270/7-52)
	graphics.minor[3].arc(100,100,150,150,270/7-38,540/7-52)
	graphics.minor[3].arc(100,100,150,150,540/7-38,810/7-52)
	graphics.minor[3].arc(100,100,150,150,810/7-38,1080/7-52)
	graphics.minor[3].arc(100,100,150,150,1080/7-38,1350/7-52)
	graphics.minor[3].arc(100,100,150,150,1350/7-38,1620/7-52)
	graphics.minor[3].arc(100,100,150,150,1620/7-38,218)
	graphics.minor[3].ellipse(100+cos(232)*67.5,100+sin(232)*67.5,10,10)
	graphics.minor[3].ellipse(100-cos(232)*67.5,100+sin(232)*67.5,10,10)
	graphics.minor[3].fill(0)
	graphics.minor[3].ellipse(100,100,120,120)
	graphics.minor[3].fill(255)
	graphics.minor[3].triangle(100,32.5,88,24.5,92,20.5)
	graphics.minor[3].triangle(100,32.5,88,40.5,92,44.5)
	graphics.minor[3].triangle(100,32.5,112,24.5,108,20.5)
	graphics.minor[3].triangle(100,32.5,112,40.5,108,44.5)
	graphics.minor[3].ellipse(100,100,90,90)
	graphics.minor[3].fill(0)
	graphics.minor[3].ellipse(100,100,75,75)
	graphics.minor[3].stroke(0)
	graphics.minor[3].strokeWeight(3)
	graphics.minor[3].fill(255)
	graphics.minor[3].beginShape()
	graphics.minor[3].vertex(60,22)
	graphics.minor[3].bezierVertex(140,80,80,120,140,178)
	graphics.minor[3].bezierVertex(60,120,120,90,60,22)
	graphics.minor[3].endShape()
	graphics.minor[3].fill(255)
	graphics.minor[3].beginShape()
	graphics.minor[3].vertex(140,22)
	graphics.minor[3].bezierVertex(60,80,120,120,60,178)
	graphics.minor[3].bezierVertex(140,120,80,90,140,22)
	graphics.minor[3].endShape()
	graphics.minor[3].ellipse(100,100,60,60)
	graphics.minor[3].fill(0)
	graphics.minor[3].noStroke()
	graphics.minor[3].arc(100,100,40,40,-135,45)
	graphics.minor[3].arc(100,100,40,40,45,225)
	graphics.minor[3].stroke(255)
	graphics.minor[3].strokeWeight(6)
	graphics.minor[3].line(85,85,115,115)
}