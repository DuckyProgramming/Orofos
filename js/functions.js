...
function displayMenu(layer){
	...
	layer.rect(210,90,100,160)
	layer.rect(210,90,60,120)
	layer.rect(300,100,20,140)
	layer.ellipse(330,40,20,20)
	layer.rect(400,100,80,140)
	layer.rect(400,100,40,100)
	layer.rect(500,90,20,160)
	layer.ellipse(530,20,20,20)
	layer.ellipse(530,90,20,20)
	layer.ellipse(470,90,20,20)
	layer.rect(600,100,80,140)
	layer.rect(600,100,40,100)
	layer.rect(710,40,80,20)
	layer.rect(710,100,80,20)
	layer.rect(710,160,80,20)
	layer.ellipse(680,70,20,20)
	layer.ellipse(740,130,20,20)
	...
	layer.noStroke()
	layer.textSize(16)
	layer.text('Ducky Programming',layer.width/2,200)
	layer.textSize(24)
